...
export class SeverityComponent implements OnInit {
  ...
  setResults(finalRes:any){
    this.auditResponse.auditResponseId=Math.abs(finalRes.auditResponseId);
    this.auditResponse.projectExecutionStatus=finalRes.projectExecutionStatus;
    this.auditResponse.remedialActionDuration=finalRes.remedialActionDuration;
