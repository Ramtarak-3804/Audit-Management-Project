...
public class ProjectManagerDetailsService implements UserDetailsService{
	...
	public ProjectManager getUserByUsername(String username) throws UsernameNotFoundException {
		return projectManagerService.getProjectManagerByUserName(username);
	}
